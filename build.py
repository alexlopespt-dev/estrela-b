...
JS_ORDER = ["core.js","vec.js","views1.js","views2.js","views3.js","cfg.js","draw.js","quick.js","print.js","actions.js","migr.js","mon.js","sync.js","boot.js"]
...
def build(seed, out):
    ...
    mj = json.load(open(os.path.join(DATA, "modelo_jogo_2627.json")))
