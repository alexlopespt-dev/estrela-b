...
p=subprocess.Popen([FF,"-y","-loglevel","error","-f","image2pipe","-framerate",str(FPS),"-c:v","mjpeg","-i","-","-i","musica_final.wav",
   "-c:v","libx264","-preset","slow","-crf","17","-pix_fmt","yuv420p","-profile:v","high","-c:a","aac","-b:a","256k","-shortest","-movflags","+faststart","Trailer_v2.mp4"],stdin=subprocess.PIPE)
